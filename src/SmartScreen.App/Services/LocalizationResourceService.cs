...
public static class LocalizationResourceService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> BuiltInFallback = new Dictionary<string, string>
    {
        ...
        ["settings.section.prompts.title"] = "Промпт-шаблони",
        ...
        ["settings.ai.systemPrompt"] = "Системний промпт",
        ...
        ["settings.prompts.prompt"] = "Промпт",
        ...
        ["settings.hotkeys.quickAiPrompt"] = "AI-промпт для швидкої дії",
        ...
        ["settings.status.promptAdded"] = "Промпт додано. Натисни «Зберегти», щоб записати",
        ...
        ["settings.status.promptDeleted"] = "Промпт видалено. Стандартні можна повернути кнопкою «Відновити»",
        ...
        ["firstRun.status.completed"] = "Перший запуск завершено",
        ...
        ["firstRun.aiRouteDescription"] = "Ключ можна додати після майстра в AI-налаштуваннях.",
        ["firstRun.hotkeys"] = "Стандартні комбінації: Ctrl+Shift+S, Ctrl+Shift+F, Ctrl+Shift+W, Ctrl+Shift+A",
        ["firstRun.start"] = "Почати",
        ["quick.title"] = "SmartScreen дії",
        ...
        ["ai.status.choosePrompt"] = "Вибери AI-дію або введи промпт",
        ...
        ["ai.error.emptyPrompt"] = "Промпт порожній. Обери AI-дію або введи власний запит.",
        ["ai.error.providerNotConfigured"] = "AI-провайдера не налаштовано.",
        ["ai.error.modelMissing"] = "Для {0} не вказано модель.",
        ["ai.error.apiKeyMissing"] = "API-ключ для {0} не вказано. Додай ключ у Налаштуваннях або через {1}.",
        ["ai.error.network"] = "Не вдалося підключитися до AI-провайдера. Перевір інтернет, endpoint і доступність сервісу.",
        ["ai.error.timeout"] = "AI-запит перевищив ліміт очікування.",
        ["ai.error.cancelled"] = "AI-запит скасовано.",
        ["ai.error.requestFailed"] = "Не вдалося виконати AI-запит. Перевір налаштування провайдера та інтернет.",
        ["ai.error.noTextResponse"] = "AI-провайдер не повернув текстову відповідь.",
        ["ai.error.geminiNoText"] = "Gemini не повернув текстову відповідь.",
        ["ai.error.geminiFinishNoText"] = "Gemini завершив відповідь без тексту: {0}.",
        ["ai.error.geminiBlocked"] = "Gemini заблокував запит: {0}.",
        ["ai.providerError.unauthorized"] = "ключ не прийнято або він не вказаний",
        ["ai.providerError.forbidden"] = "немає доступу до моделі або endpoint",
        ["ai.providerError.notFound"] = "модель або endpoint не знайдено",
        ["ai.providerError.timeout"] = "провайдер не дочекався запиту",
        ["ai.providerError.tooLarge"] = "скріншот завеликий для провайдера",
        ["ai.providerError.unprocessable"] = "провайдер не зміг обробити формат запиту",
        ["ai.providerError.rateLimited"] = "перевищено ліміт запитів або квоту",
        ["ai.providerError.server"] = "тимчасова помилка на стороні провайдера",
        ["ai.providerError.generic"] = "провайдер повернув помилку",
        ["clipboard.error.busy"] = "Буфер обміну тимчасово зайнятий іншою програмою.",
